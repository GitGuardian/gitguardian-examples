...
Requires [`uv`](https://docs.astral.sh/uv/), a GitGuardian personal access token (`scan` scope, from https://dashboard.gitguardian.com/api/personal-access-tokens), and at least one of `OPENAI_API_KEY` / `ANTHROPIC_API_KEY` / `MISTRAL_API_KEY`.
